...
def display_expense_history():
   ...
   df_expense = pd.DataFrame({"id":[],"amount":[],"date" : [], "event_name":[], "expense_type":[]})
...
def display_expense_graph():
   ...
   return df_expense.groupby("expense_type").mean().plot.bar(barmode = "group", template = "plotly_white")
